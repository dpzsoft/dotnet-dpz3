...
namespace dpz3.Markdown {
    ...
    public static class Parser {
        ...
        // 处理换行
        private static void ExecuteTurnLine(MdDocument doc, StringBuilder sb, ref MdBasicBlock pb, ref MdTextLine tlBefore, ref int pt, ref int blk, ref int blkBefore, ref int ls, ref int lsBefore) {
            #region [=====处理换行=====]

...
namespace dpz3.db {
    ...
    /// 通用数据库连接管理器
    /// </summary>
    public class Connection : dpz3.Object, IConnectionable {

        private Connectiones.IConnectionable dbc = null; //数据库连接管理器
        private dpz3.db.Database db;    //数据库定义对象
        ...
        /// 获取数据库类型
        /// </summary>
        public dpz3.db.DatabaseTypes DatabaseType { get; private set; }
        ...
        public Connection(dpz3.db.Database database) {
            db = database;
